...
const WhatsInsideSection = () => {
  ...
  const loadDataFromFirebase = async () => {
    ...
    try {
      setLoading(true);
      const docRef = doc(db, 'bundlepage', 'whatsinside');
  ...
  return (
    <div className="bundle-section-container">
      <div className="section-header-row">
        <h2 className="section-main-title">Whats Inside Section Configuration</h2>
      ...
      <div className="config-section">
        <div className="section-content-area">
          ...
          {/* Cards Section */}
          <div className="form-group">
            <label className="form-label">Cards Section (5 Cards)</label>
