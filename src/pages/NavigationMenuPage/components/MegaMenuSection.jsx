...
const MegaMenuSection = () => {
  ...
  const loadDataFromFirebase = async () => {
    ...
    try {
      setLoading(true);
      const docRef = doc(db, 'navigation', 'megamenu');
  ...
  return (
    <div className="navigation-section-container">
      <div className="section-header-row">
        <h2 className="section-main-title">Mega Menu Configuration</h2>
      ...
      <div className="config-section">
        <div className="section-content-area">
          <div className="add-item-header">
            <p className="section-description">Add sections for the mega menu. Each section has a label and multiple menu items.</p>
          ...
          {sections.length === 0 ? (
            <div className="empty-placeholder">
              ...
              <h3>No Sections</h3>
              <p>Click "Add Section" to add your first mega menu section</p>
            </div>
          ) : (
